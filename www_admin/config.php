...
<tr>
  <td>Voting type:</td>
  <td>
  <div><input type="radio" name="voting_type" value="preferential" checked="checked"/> <a href="http://en.wikipedia.org/wiki/Preferential_voting">Preferential voting</a> (users select their top 3 entries)</div>
  <div><input type="radio" name="voting_type" value="range"/> <a href="http://en.wikipedia.org/wiki/Range_voting">Range voting</a> (users assign ratings to each entry)</div>
  </td>
</tr>
